...
import { Icons, Loading, useToast, ToastProvider } from '@miq/components';
...
const propTypes = {
  match: PropTypes.shape({ match: PropTypes.string }).isRequired,
};
          ...
          <Suspense fallback={<Loading label="Main loading" />}>
            <Switch>
              <AdminRoute
                ...
                requiredPerms={['miq_dms.view_document']}
              />
              <AdminRoute path={`${path}company/`} component={HrmRoutes} requiredPerms={['miq_hrm.view_employee']} />
